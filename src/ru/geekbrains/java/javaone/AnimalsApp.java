...
4. При попытке животного выполнить одно из этих действий, оно должно сообщить результат в консоль. (Например, dog1
.run(150); -> результат: run: true)
...
public class AnimalsApp {
    public static void main(String[] args) {
        ...
        System.out.println("run: " + cat1.run(50));
        System.out.println(cat1.swim(30));
        System.out.println("jump: " + dog1.jump(0.2));
        System.out.println("swim: " + dog1.swim(20));
        System.out.println("run: " + dog1.run(700));
        System.out.println("run: " + dog2.run(700));
    }
}
